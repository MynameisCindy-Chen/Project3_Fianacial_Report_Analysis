...
st.snow()
st.sidebar.title("Presentation Outline")

with st.sidebar:
    selected = option_menu(
        menu_title ="Revenue/NetSales Forcast:",
        options = ["1. Financial Data Performance and Visualization", "2. Check Stationary", "3. Differencing and Autocorrelation", "4. Auto-ARIMA Model Fitting and Forecasting", "5. ARIMA Model Fitting and Forecasting"],
        icons=['snow2','snow2','snow2','snow2','snow2'],
        menu_icon='house-check-fill',
        default_index=0
    )
    
# Navigate to first part
if selected == "1. Financial Data Performance and Visualization":
    # Add subheader
...
# Navigate to second part
if selected == "2. Check Stationary":
    # ARIMA Model
...
# Navigate to third part
if selected == "3. Differencing and Autocorrelation":
...
# Navigate to fourth part
if selected == "4. Auto-ARIMA Model Fitting and Forecasting":
...
# Naviagte to fifth part
if selected == "5. ARIMA Model Fitting and Forecasting":
